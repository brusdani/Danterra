...
public class ProstorTest
{
    ...
    public  void testLzeProjit() {		
        Prostor prostor1 = new Prostor("hala", "vstupní hala budovy VŠE na Jižním městě",false,null);
        Prostor prostor2 = new Prostor("bufet", "bufet, kam si můžete zajít na svačinku",false, null);
